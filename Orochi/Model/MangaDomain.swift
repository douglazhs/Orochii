...
struct MangaDomain: Identifiable, Hashable {
    ...
    static let samples: [MangaDomain] = [
        ...
        .init(title: "Chainsaw Man", genres: ["Action", "Comedy", "Drama", "Horror", "Supernatural"], status: .ongoing, year: "2019", author: "Tatsuki Fujimoto", cover: "chainsaw", lastUpdated: "10/10/2022", published: "Published", description: testDescription, hasUpdate: true),
        .init(title: "Vagabond", genres: ["Action", "Adventure", "Drama"], status: .hiatus, year: "1999", author: "Takehiko Inoue", cover: "vagabond", lastUpdated: "10/10/2022", published: "Published", description: testDescription, hasUpdate: false),
        ...
        .init(title: "Jujutsu Kaisen", genres: ["Thriller", "Monsters", "Magic"], status: .completed, year: "2018", author: "Eiichiro Oda", cover: "jujutsu", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: false),
        .init(title: "Naruto Shippuden", genres: ["Thriller", "Monsters", "Magic"], status: .hiatus, year: "2018", author: "Gege Akutami", cover: "naruto", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: true),
        .init(title: "Demon Slayer: Kimetsu no Yaiba Entertainment District Arc", genres: ["Thriller", "Monsters", "Magic"], status: .hiatus, year: "2018", author: "Gege Akutami", cover: "kimetsu", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: false),
        .init(title: "Fullmetal Alchemist Brotherhood", genres: ["Thriller", "Monsters", "Magic"], status: .hiatus, year: "2018", author: "Gege Akutami", cover: "fullmetal", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: true)
    ]
}
