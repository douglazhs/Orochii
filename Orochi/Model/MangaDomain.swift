...
struct MangaDomain: Identifiable, Hashable {
    ...
    static let samples: [MangaDomain] = [
        ...
        .init(title: "Chainsaw Man", genres: ["Action", "Comedy", "Demons", "Horror", "Supernatural", "Police"], status: .rereading, year: "2018", author: "Fujimoto Tatsuki", cover: "chainsaw", lastUpdated: "10/10/2022", published: "Published", description: testDescription, hasUpdate: true),
        ...
        .init(title: "Hunter x Hunter", genres: ["Action", "Adventure", "Slice of Life", "Medical", "Fantasy"], status: .reading, year: "1998", author: "Togashi Yoshihiro", cover: "hunter", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: false),
        .init(title: "Slam Dunk!", genres: ["Delinquents", "School Life", "Comedy", "Sports", "Slice of Life"], status: .rereading, year: "1990", author: "Inoue Takehiko", cover: "slam", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: false),
        .init(title: "One Piece", genres: ["Action", "Adventure", "Comedy", "Fantasy", "Martial Arts"], status: .reading, year: "1997", author: "Oda Eiichiro", cover: "onepiece", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: false),
        ...
        .init(title: "Kimetsu no Yaiba", genres: ["Historical", "Demons", "Supernatural", "Adventure"], status: .reading, year: "2014", author: "Gotouge Koyoharu", cover: "kimetsu", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: false),
        .init(title: "Fullmetal Alchemist", genres: ["Thriller", "Adventure", "Action", "Award Winning"], status: .reading, year: "2001", author: "Gege Akutami", cover: "fullmetal", lastUpdated: "2022/09/10", published: "Published", description: testDescription, hasUpdate: true)
    ]
}
